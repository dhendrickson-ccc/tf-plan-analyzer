...
class HCLValueResolver:
    ...
    def _parse_variable_definitions(self, content: str) -> None:
        ...
        for match in var_pattern.finditer(content):
            ...
            if default_match:
                ...
                if var_name not in self.variables:  # Only set if not already set by tfvars
    ...
    def _parse_resource_body(self, body: str) -> Dict[str, Any]:
        ...
        map_assignment_pattern = re.compile(
            r'^\s*(\w+)\s*=\s*\{',
            re.MULTILINE
        )
    ...
    def get_resource_attribute(self, resource_address: str, attribute_path: str) -> Optional[Any]:
        """
