...
class TestComputeAttributeDiffs:
    ...
    def test_single_attribute_difference(self):
        ...
        if hasattr(rc, "compute_attribute_diffs"):
            ...
            location_diffs = [
                ad for ad in rc.attribute_diffs if ad.attribute_name == "location"
            ]
    ...
    def test_nested_object_attribute(self):
        ...
        if hasattr(rc, "compute_attribute_diffs"):
            ...
            if hasattr(rc, "attribute_diffs"):
                ...
                identity_diffs = [
                    ad for ad in rc.attribute_diffs if ad.attribute_name == "identity"
                ]
    ...
    def test_multiple_environments(self):
        ...
        if hasattr(rc, "compute_attribute_diffs"):
            ...
            if hasattr(rc, "attribute_diffs"):
                ...
                bucket_diffs = [
                    ad for ad in rc.attribute_diffs if ad.attribute_name == "bucket"
                ]
                region_diffs = [
                    ad for ad in rc.attribute_diffs if ad.attribute_name == "region"
                ]
