...
class TestLoadIgnoreConfig:
    ...
    def test_valid_json_with_all_fields(self, tmp_path):
        ...
        config_data = {
            "global_ignores": {"tags": "Tags managed separately"},
            "resource_ignores": {
    ...
    def test_valid_json_list_format(self, tmp_path):
        ...
        config_data = {
            ...
            "resource_ignores": {"azurerm_resource": ["field1", "field2"]},
        }
        config_file.write_text(json.dumps(config_data))
    ...
    def test_invalid_resource_fields_type(self, tmp_path):
        ...
        config_file = tmp_path / "invalid.json"
        config_data = {"resource_ignores": {"azurerm_resource": "string_not_allowed"}}
        config_file.write_text(json.dumps(config_data))
...
class TestApplyIgnoreConfig:
    ...
    def test_resource_specific_ignore(self):
        ...
        rules = {"resource_ignores": {"azurerm_monitor_metric_alert": ["description"]}}
    ...
    def test_combined_global_and_resource_specific(self):
        ...
        rules = {
            "global_ignores": ["tags"],
            "resource_ignores": {"azurerm_resource": ["description"]},
        }
    ...
    def test_nested_attribute_ignore(self):
        ...
        config = {
            "name": "test",
            "identity": {"type": "SystemAssigned", "principal_id": "12345"},
        }
...
class TestSupportsDotNotation:
    ...
    def test_nested_attribute_exists(self):
        ...
        config = {"identity": {"type": "SystemAssigned", "principal_id": "12345"}}
