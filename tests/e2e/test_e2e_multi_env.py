...
class TestCLIRouting:
    ...
    def test_no_subcommand_shows_help(self):
        ...
        result = subprocess.run(
            ["python3", "src/cli/analyze_plan.py"], capture_output=True, text=True
        )
    ...
    def test_compare_five_environments(self):
        ...
        result = subprocess.run(
            [
                ...
                "compare",
                "tests/fixtures/dev-plan.json",
                "tests/fixtures/qa-plan.json",
                "tests/fixtures/staging-plan.json",
                "tests/fixtures/preprod-plan.json",
                "tests/fixtures/prod-plan.json",
                "--html",
                output_file,
            ],
    ...
    def test_sensitive_values_masked_by_default(self):
        ...
        result = subprocess.run(
            [
                ...
                "src/cli/analyze_plan.py",
                "compare",
                "tests/fixtures/dev-sensitive.json",
        ...
        assert (
            "[SENSITIVE]" in result.stdout
            or "SENSITIVE" in result.stdout
    ...
    def test_tfvars_count_mismatch_error(self):
        ...
        result = subprocess.run(
            [
                ...
                "tests/fixtures/prod-plan.json",
                "--tfvars-files",
                "dev.tfvars,staging.tfvars",
            ],  # Only 2 tfvars for 3 files
            capture_output=True,
            text=True,
        )
        assert result.returncode == 1
    ...
    def test_diff_only_filters_identical_resources(self):
        ...
        result = subprocess.run(
            [
                ...
                "src/cli/analyze_plan.py",
                "compare",
                "tests/fixtures/test1-plan.json",
                "tests/fixtures/test2-plan.json",
                "--diff-only",
                "--html",
                output_file,
            ],
    ...
    def test_ignore_config_filters_fields(self):
        ...
        result = subprocess.run(
            [
                ...
                "tests/fixtures/staging-plan.json",
                "--config",
                "tests/fixtures/ignore_config.json",
                "--html",
                output_file,
            ],
            capture_output=True,
